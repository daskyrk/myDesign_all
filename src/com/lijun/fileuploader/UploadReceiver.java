package com.lijun.fileuploader;
...
{
    private static final File UPLOAD_DIR = new File("D:\\test/uploads");
...
//            resp.addHeader("Access-Control-Allow-Origin", "*");
    ...
    private String writeFileForNonMultipartRequest(HttpServletRequest req, RequestParser requestParser) throws Exception
    {
...
//    	File dir = UPLOAD_DIR;
    ...
    private String writeFileForMultipartRequest(RequestParser requestParser) throws Exception
    {
      File dir = new File(UPLOAD_DIR, requestParser.getUuid());
//    	File dir = UPLOAD_DIR;
        dir.mkdirs();
